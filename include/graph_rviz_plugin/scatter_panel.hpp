#ifndef GRAPH_RVIZ_PLUGIN_SCATTER_PANEL_HPP
#define GRAPH_RVIZ_PLUGIN_SCATTER_PANEL_HPP
...
class ScatterPanel: public rviz::Panel
{
Q_OBJECT

public:
  ScatterPanel(QWidget *parent = 0);
  virtual ~ScatterPanel();
